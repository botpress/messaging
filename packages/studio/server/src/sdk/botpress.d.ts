...
declare module 'botpress/sdk' {
  ...
  export interface KvsService {
     ...
     */
    setStorageWithExpiry(key: string, value: any, expiry?: string): void
    /**
  ...
  export namespace realtime {
     ...
     */
    export function sendPayload(payload: RealTimePayload): void
    /**
  ...
  export namespace http {
     ...
     */
    export function deleteShortLink(name: string): void
     ...
     */
    export function deleteRouterForBot(routerName: string): void
  ...
  export namespace kvs {
     ...
     * @deprecated will be removed, use global or forBot
     */
    export function setStorageWithExpiry(botId: string, key: string, value: any, expiry?: string): any

    /**
     * @deprecated will be removed, use global or forBot
     */
    export function getStorageWithExpiry(botId: string, key: string): any
     ...
     * @deprecated will be removed, use global or forBot
     */
    export function removeStorageKeysStartingWith(key: string): Promise<void>
  }
  ...
  export namespace cms {
    ...
    export function readFile(botId: string, fileName: string): Promise<Buffer>
