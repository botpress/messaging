...
class ScenarioRecorder extends React.Component<Props, State> {
  ...
  startRecording = async () => {
    ...
    await this.props.axios.post('/testing/startRecording', { userId: chatUserId })
  }

  stopRecording = async () => {
    window.botpressWebChat.sendEvent({ type: 'hide' })

    const { data } = await this.props.axios.post('/testing/stopRecording')
  ...
  saveScenario = async () => {
    ...
    await this.props.axios.post('/testing/saveScenario', {
      name: scenarioName,
